 ...
 *
 * Deliberately scoped to setup rather than made a `components/` primitive. It
 * was promoted there for MAI-104's pinned-bar fold and moved back when MAI-106
 * removed that fold — two consumers, both here, so a shared home would be a
 * breadcrumb to a caller that no longer exists. `CourseSearch` reached a
 * different answer for the same problem (↓/↑ in a body-font row) and unifying
 * the two is not this ticket.
 */
